  ...
  return (
    <div className="space-y-12 sm:space-y-16 pb-6 animate-in fade-in">
      ...
      <div className="text-center pt-2">
        <span className="text-[11px] font-bold uppercase tracking-widest text-[#867468] block mb-3">
          {t.supportedBy}
        </span>
        <div className="flex flex-wrap items-center justify-center gap-8 text-xs font-bold text-[#534439]/70 uppercase tracking-wider">
